...
mydb = sql.connect(host="yourhost_name",
                   user="youruser_name",
                   password="",
...
with st.sidebar:
    selected =option_menu("Menu", ["Home", "Top Charts", "Visualization"],
...
if selected == "Home":
    ...
    st.sidebar.image(
        "https://miro.medium.com/v2/resize:fit:1400/1*w-wizVCoOO_xSiKgv4hjZQ.gif",
        width=310)
    ...
    with col2:
        ...
        st.image("https://www.emoneywallets.com/wp-content/uploads/2021/07/ezgif-1-d6928d437c51.gif", width=460)
...
if selected == "Top Charts":
    ...
    with colum2:
        ...
        # Display the info message with custom styling

        st.info(
        """
        #### PhonePe Pulse Data Visualization 🔍
        Explore insights like overall rankings, top regions by transactions and spending, active users, and popular mobile brands.
        Select Year and Quarter, Type (State/District), and Top 10 options.
        Interact with the visualizations to gain valuable data-driven insights.
        Note: This dashboard provides historical data and is for informational purposes only.
        Enjoy exploring PhonePe Pulse Data Visualization and Exploration! 🚀
        """
        )
...
if selected == "Visualization":
    ...
    if Type == "Transactions":
        ...
        df2 = pd.read_csv(r'C:\Users\Admin\Downloads\project\Statenames.csv')
        df1.State = df2
